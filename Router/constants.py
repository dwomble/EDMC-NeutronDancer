...
HEADER_MAP:dict = {"system": "System Name", "name": "System Name",
                   ...
                   "distance_left": "Distance Rem", "distance_to_destination": "Dist Rem",
                    ...
                    "body_name": "Body", "subtype": "Body Type", "is_terraformable": "Is Terra",
                    "distance_to_arrival": "Dist To Arrival", "estimated_scan_value": "Est Scan Value",
                    "estimated_mapping_value": "Est Mapping Value",
                    "species": "Species", "landmark_value": "Value",
...
HEADERS:list = ["System Name", "Station Name", "Jumps", "Jumps Rem", "Waypoints", "Waypoints Rem", "Neutron",
                "Body", "Body Type", "Is Terra", "Species", "Value", "Commodity", "Amount",
                "Profit", "Total Profit", "Cumulative Profit", "Dist To Arrival", "Est Scan Value",
                "Est Mapping Value", "Distance", "Distance Jumped", "Distance Rem", "Distance Remaining",
...
HEADER_TYPES:dict = {"System Name": ["str", ""],
                    ...
                    "Dist To Arrival": ["float", "", " ls"],
                    "Est Scan Value": ["float", "", " Cr"],
                    "Est Mapping Value": ["float", "", " Cr"],
                    "Value": ["float", "", " Cr"],
                    "Distance": ["float", "", " ly"],
...
tts:dict = {
    ...
    "min_body_value": "Minimum value to look for",
    "min_species_value": "Minimum species value to look for, in millions of credits",
    ...
    "max_distance": "Maximum distance from arrival point, in light seconds",
